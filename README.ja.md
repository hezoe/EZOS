...
- 📖 **取扱説明書（多言語 / 日本語・English・עברית）**: [docs/manual/index.html](docs/manual/index.html)
...
- 🛠 **インストールマニュアル（別冊 / 日本語・English・עברית）**: [docs/manual/install.ja.html](docs/manual/install.ja.html) ／ [install.en.html](docs/manual/install.en.html)（Markdown 版: [docs/INSTALL.md](docs/INSTALL.md)）
...
[MIT License](LICENSE) で公開しています。利用・改変・再配布は自由です。詳細は `LICENSE` を参照してください。
